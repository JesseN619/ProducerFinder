...
export const CreatePlaylist = () => {
  ...
  const createPlaylist = async () => {
    ...
    document.getElementById("success")!.className =
      "text-white flex bg-green-400 border-2 px-3 ml-3 self-center rounded";
    return data;
  };
  ...
  const getPlaylists = useCallback(async () => {
    ...
    select.addEventListener("change", (e) => {
      ...
      dispatch(
        setPlaylistName(userPlaylists[(e.target as HTMLSelectElement)!.value!])
      );
    });
  }, [dispatch, headers, userId]);
